...
class Korisnik(models.Model):
    ...
    lozinka = models.CharField(max_length=45, blank=True, null=True)
...
class Ocena(models.Model):
    ...
    idrez = models.ForeignKey('Rezervacija', models.DO_NOTHING, db_column='idrez', blank=True, null=True)
...
class Rezervacija(models.Model):
    ...
    idsmestaj = models.ForeignKey('Smestaj', models.DO_NOTHING, related_name='rezs', db_column='idsmestaj', blank=True, null=True)
...
class Smestaj(models.Model):
    ...
    idkorisnikvlasnik = models.ForeignKey(Korisnik, models.DO_NOTHING, db_column='idkorisnikvlasnik', blank=True, null=True)
